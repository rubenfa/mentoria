...
El día que juegues  a un videojuego y comiences a pensar en algorítmos de pintor sabrás a lo que me refiero y si sientes o no pasión por el desarrollo, mientras tanto, con curiosidad me vale.

# Perfil
Prácticamente toda mi vida laboral la he dedicado al desarrollo. Normalmente en consultoría realizando aplicaciones para clientes.

Prácticamente he hecho un poco de todo desde aplicaciones de facturación a aplicaciones de centralita, análisis clínicos, calibración de trenes o una herramienta para los técnicos de los  Juegos Olímpicos de Pekín.

Y es por eso que aunque en mi nómina pone analista funcional y jefe de proyecto, mi día a día sigue siendo el desarrollo. Digo de cuando en cuando que soy ingeniero de software aunque mi perfil real es el de programador enteradillo, es decir, sé un poco de todo y dedico  gran parte del tiempo en mi trabajo a los temas complejos y de arquitectura, aunque de vez en cuando eso implique ponerle colorines a una pantalla.
...
Aunque ya sabía algo de programación cuando entré en la Universidad, fue allí donde aprendí a programar de verdad. Sé que a muchos la Universidad les parece una pérdida de tiempo, un lugar donde te enseñarán cosas que luego no vas a utilizar nunca, pero da una base sólida de conocimientos y te obliga a centrarte en temas que posiblemente nunca aprenderías por tu cuenta.

Los conocimientos de estructuras de datos y algoritmos son básicos, las matemáticas son importantes si algún día te enfrentas a problemas relacionados con minería de datos, criptografía o programación gráfica vas a agradecer los años que pasaste aprendiendo cálculo o estadística. No creo que nunca me hubiese atrevido a escribir un compilador sin mi base universitaria.

Pero la Universidad no es el único camino, para mí de hecho es una consecuencia de una formación que empezó mucho antes y creo que se debe llegar a ella con conocimientos más o menos sólidos sobre programación.
...
* Intenta no ir demasiado rápido: la programación "real" actual tiene una curva de aprendizaje muy alta e incluso a personas que llevamos mucho tiempo en esto nos cuesta sudor y lágrimas, así que aunque escuches hablar de frameworks como Angular, Json, XML, Elixir, Erlang, RabitMQ, Laravel, Xamarin, NoSql o cosas similares, céntrate en aprender las bases. Tendrás tiempo para avanzar.

* Concédete una segunda oportunidad: la programación es complicada y creo que todos en algún momento hemos pensado en tirar la toalla. Cuando te ocurra, date un tiempo y vuelve a lo básico.
...
* Pregunta, asiste a conferencias sin abrumarte, ve vídeos, lee mucho código... Internet está llena de gente que comparte sus conocimientos. Eso sí, sé respetuoso y no pretendas que te hagamos los deberes. Cada vez que preguntes a alguien considera que te ayuda en su tiempo libre y que compites con su familia, amigos y sus propios proyectos: pregunta lo que quieres saber en contexto, hasta dónde has llegado y lo que has probado. Un gracias y un por favor nunca vienen mal y si alguien te dice "no lo sé" no te lo tomes a mal, posiblemente no lo sepa.
